...
code mechanism provides a \emph{CachePattern} interface\ab{Interface? I do not understand. Are you referring to the class hierarchy given in Figure 3}\sv{Si me refiero a eso. Gracias por darte cuenta del error. En realidad es una clase abstracta: CachePattern}. In this way,
