...
use. As was mentioned in the previous section, the main general purposes
identified are: 
\begin{itemize}
...
it introduced indirections to access to the caches \ab{this is an
important point, we are currently saying that classical composition
mechanism of OO languages is not enough. This is a good point for
using AOP and reflection}. Indirections caused a poor performance
...
of define the pragma inside the method is in order to allow a better
...
section, the code related to the cache is extracted to the before
