...
are grouped together based on the purpose of its use. Each group is associated with different activities: 
\begin{itemize}
...
\sv{Cambie lo de grupo y subgrupo porque era confuso} 
...
repeated in the use of the caches. For each patter found a refactoring strategy is defined. These code patterns are described in the
...
\figref{PatternLocation} shows the distribution of the caches over the main Mondrian classes.
