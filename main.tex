...
Van der Rijst et al.~\cite{Rijst2008,Marin2009} propose a migration strategy based on crosscutting concern sorts. With this approach the cross-cutting concerns are described by means of concern sorts. In order to refactor the code, each specific crosscutting concern sort indicates what refactorings should be applied to encapsulate it into an aspect. 
