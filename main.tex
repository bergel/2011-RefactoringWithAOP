...
\ab{here}
In order to solve these problems a refactorization of the caches is needed to modularize them. However, modularizing caches cannot be realizing without loosing performances.
...
of the caches. To accomplish this task could
be used, for example, a strategy which uses a class containing a collection of caches
...
\begin{figure*}
\begin{centering}
\includegraphics[bb=55bp 65bp 280bp 630bp,clip,angle=-90,scale=0.80]{benchmarks}
\par\end{centering}

\caption{Benchmark of perfomance.\label{fig:Benchmark}}
